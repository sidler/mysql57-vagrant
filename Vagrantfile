...
Vagrant.configure("2") do |config|
  ...
  # documentation for more information about their specific syntax and use.
   config.vm.provision "shell", inline: <<-SHELL
  		...
  		rpm -Uh http://dev.mysql.com/get/mysql57-community-release-el7-8.noarch.rpm 
  		yum install -y mysql-community-server 

  		systemctl start mysqld
		systemctl enable mysqld
  		
  		echo 'mysql temporary root password: '
	    ...
	    mysql -u root -pPassw0rd! -e 'UNINSTALL PLUGIN validate_password' 
	    mysqladmin -u root -pPassw0rd! password 'root'
	    ...
	    echo 'mysql is available at port 3336, user root, password root'
	    echo 'connect from your local box using'
	    echo ' mysql -P 3336 -u root -p -h 127.0.0.1'
